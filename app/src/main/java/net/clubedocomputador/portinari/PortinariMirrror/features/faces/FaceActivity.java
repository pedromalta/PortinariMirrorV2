...
import net.clubedocomputador.portinari.databinding.ActivityFaceBinding;
import net.clubedocomputador.portinari.features.base.BaseActivity;
import net.clubedocomputador.portinari.features.faces.widget.CameraSourcePreview;
import net.clubedocomputador.portinari.features.faces.widget.FaceGraphic;
import net.clubedocomputador.portinari.features.faces.widget.GraphicOverlay;
