package net.clubedocomputador.portinari.features.base;
...
import net.clubedocomputador.portinari.AppNameApplication;
import net.clubedocomputador.portinari.util.AppLogger;
import net.clubedocomputador.portinari.util.Util;
import butterknife.ButterKnife;
import net.clubedocomputador.portinari.injection.component.ConfigPersistentComponent;
import net.clubedocomputador.portinari.injection.component.DaggerConfigPersistentComponent;
import net.clubedocomputador.portinari.injection.component.FragmentComponent;
